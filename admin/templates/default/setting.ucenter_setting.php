  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="index.php?act=account&op=qq"><span><?php echo $lang['qqSettings'];?></span></a></li>
        <li><a href="index.php?act=account&op=sina"><span><?php echo $lang['sinaSettings'];?></span></a></li>
      </ul>
    </div>
  </div>
      ...
      <tbody>
        ...
        <tr class="noborder">
          <td class="vatop rowform onoff"><label for="ucenter_status1" class="cb-enable <?php if($output['list_setting']['ucenter_status'] == '1'){ ?>selected<?php } ?>"><span><?php echo $lang['ztc_isuse_open'];?></span></label>
            ...
            &nbsp;&nbsp; <a href="http://bbs.shopnc.net/forum.php?mod=viewthread&tid=8663" target="_blank"><?php echo $lang['ucenter_help_url']; ?></a></td>
