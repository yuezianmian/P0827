      ...
      <tbody>
        ...
        <tr class="noborder">
          <td class="vatop rowform">
              <input type="text" id="pg_name" name="pg_name" class="txt">
          </td>
          <td class="vatop tips"></td>
        </tr>
        <tr class="noborder">
            <td colspan="2" class="required"><label class="validation" for="pg_img">商品图片:</label></td>
        </tr>
        <tr class="noborder">
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" id="pg_points" name="pg_points" class="txt" ></td>
          <td class="vatop tips"></td>
        </tr>
        <tr>
        ...
        <tr class="noborder">
            <td class="vatop rowform"><input type="text" id="pg_stock" name="pg_stock" class="txt" ></td>
            <td class="vatop tips"></td>
        </tr>
        <tr>
        ...
        <tr class="noborder">
            <td class="vatop rowform" colspan="2"><?php showEditor('pg_desc');?></td>
            <td class="vatop tips"></td>
        </tr>
      </tbody>
      <tfoot>
