...
-- 正在导出表  bdm175223116_db.sysc_admin 的数据：2 rows
...
INSERT INTO `sysc_admin` (`admin_id`, `admin_name`, `admin_password`, `admin_login_time`, `admin_login_num`, `admin_is_super`, `admin_gid`) VALUES
	(1, 'admin', '96e79218965eb72c92a549dd5a330112', 1441868870, 106, 1, 0),
	(13, 'orange', '96e79218965eb72c92a549dd5a330112', 0, 0, 0, 0);
...
CREATE TABLE IF NOT EXISTS `sysc_admin_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='管理员操作日志';

-- 正在导出表  bdm175223116_db.sysc_admin_log 的数据：2 rows
...
CREATE TABLE IF NOT EXISTS `sysc_member` (
  ...
  `area_name` varchar(50) DEFAULT NULL COMMENT '店铺区域，或代理商所属区域',
...
-- 正在导出表  bdm175223116_db.sysc_member 的数据：4 rows
/*!40000 ALTER TABLE `sysc_member` DISABLE KEYS */;
INSERT INTO `sysc_member` (`member_id`, `member_name`, `member_truename`, `member_mobile`, `member_avatar`, `member_sex`, `member_birthday`, `member_passwd`, `member_points`, `member_state`, `member_type`, `member_code`, `parent_code`, `create_time`, `shop_name`, `shop_img`, `area_name`, `area_id`, `shop_address`, `alipay_number`, `bank_number`, `bank_username`, `bank_name`, `bank_branch`) VALUES
	(1, NULL, NULL, '18682255279', NULL, NULL, NULL, '96e79218965eb72c92a549dd5a330112', 0, 2, 1, '55555', NULL, '1440378734', NULL, NULL, '天津市和平区', 55, NULL, NULL, NULL, NULL, NULL, NULL),
	(2, NULL, NULL, '18682255278', NULL, NULL, NULL, '96e79218965eb72c92a549dd5a330112', 10, 1, 2, NULL, '55555', '1440378734', '店面1', '/data/upload/img/default_user_portrait.gif', '天津市和平区', 55, 'xx街道xx号', NULL, NULL, NULL, NULL, NULL),
	(3, NULL, NULL, '18682255277', NULL, NULL, NULL, '96e79218965eb72c92a549dd5a330112', 10, 3, 2, NULL, '55555', '1440378734', '', '', '天津市和平区', NULL, 'xx街道xx号', NULL, NULL, NULL, NULL, NULL),
	(6, NULL, NULL, '18611111113', NULL, NULL, NULL, '96e79218965eb72c92a549dd5a330112', 0, 2, 1, '10018', NULL, '1441877010', NULL, NULL, '北京市东城区', 37, NULL, NULL, NULL, NULL, NULL, NULL);
...
-- 正在导出表  bdm175223116_db.sysc_points_log 的数据：0 rows
