...
-- 导出  表 bdm175223116_db.sysc_admin 结构
CREATE TABLE IF NOT EXISTS `sysc_admin` (
...
-- 导出  表 bdm175223116_db.sysc_admin_log 结构
CREATE TABLE IF NOT EXISTS `sysc_admin_log` (
...
INSERT INTO `sysc_admin_log` (`id`, `content`, `createtime`, `admin_name`, `admin_id`, `ip`, `url`) VALUES
	...
	(2, '添加会员[	18611111113]', 1441877010, 'admin', 1, '127.0.0.1', 'member&member_add'),
	(3, '审核会员不通过[ID:2]', 1441940513, 'admin', 1, '127.0.0.1', 'member&nopass'),
	(4, '审核会员通过[ID:2]', 1441940583, 'admin', 1, '127.0.0.1', 'member&pass'),
	(5, '编辑会员[ID:2]', 1441959049, 'admin', 1, '127.0.0.1', 'member&member_edit'),
	(6, '编辑会员[ID:2]', 1441959077, 'admin', 1, '127.0.0.1', 'member&member_edit'),
	(7, '编辑会员[ID:2]', 1441959083, 'admin', 1, '127.0.0.1', 'member&member_edit'),
	(8, '编辑会员[ID:2]', 1441959304, 'admin', 1, '127.0.0.1', 'member&member_edit'),
	(9, '编辑会员[ID:2]', 1441959362, 'admin', 1, '127.0.0.1', 'member&member_edit'),
	(10, '审核会员通过[ID:2]', 1441959368, 'admin', 1, '127.0.0.1', 'member&pass'),
	(11, '管理员', 1442284874, 'admin', 1, '', 'admin&admin'),
	(12, '添加管理员[apple]', 1442284892, 'admin', 1, '', 'admin&admin_add'),
	(13, '编辑产品[产品01]', 1442285646, 'admin', 1, '', 'product&product_edit'),
	(14, '添加产品[产品02]', 1442285747, 'admin', 1, '', 'product&product_add'),
	(15, '编辑产品[产品01]', 1442285772, 'admin', 1, '', 'product&product_edit'),
	(16, '添加产品[产品03]', 1442286516, 'admin', 1, '', 'product&product_add'),
	(17, '删除产品[ID:1,2,3]', 1442286537, 'admin', 1, '', 'product&product'),
	(18, '添加产品[产品1]', 1442286556, 'admin', 1, '', 'product&product_add'),
	(19, '添加产品[产品2]', 1442286567, 'admin', 1, '', 'product&product_add'),
	(20, '删除产品[ID:]', 1442286572, 'admin', 1, '', 'product&product_del'),
	(21, '添加产品[产品2]', 1442286583, 'admin', 1, '', 'product&product_add'),
	(22, '编辑产品中心地址[http://www.aidu.com]', 1442308031, 'admin', 1, '', 'product&productcenter'),
	(23, '编辑产品中心地址[http://www.baidu.com]', 1442308195, 'admin', 1, '', 'product&productcenter'),
	(24, '添加Banner[1]', 1443018997, 'admin', 1, '', 'banner&banner_add'),
	(25, '添加Banner[2]', 1443019078, 'admin', 1, '', 'banner&banner_add'),
	(26, '添加Banner[3]', 1443019242, 'admin', 1, '', 'banner&banner_add'),
	(27, '编辑Banner[3]', 1443020617, 'admin', 1, '', 'banner&banner_edit'),
	(28, '编辑Banner[3]', 1443020642, 'admin', 1, '', 'banner&banner_edit'),
	(29, '编辑Banner[3]', 1443020690, 'admin', 1, '', 'banner&banner_edit'),
	(30, '编辑Banner[3]', 1443020706, 'admin', 1, '', 'banner&banner_edit'),
	(31, '编辑Banner[3]', 1443020779, 'admin', 1, '', 'banner&banner_edit'),
	(32, '添加Banner[4]', 1443020799, 'admin', 1, '', 'banner&banner_add'),
	(33, '删除Banner[ID:]', 1443020807, 'admin', 1, '', 'banner&banner_del'),
	(34, '添加Banner[5]', 1443020821, 'admin', 1, '', 'banner&banner_add'),
	(35, '删除banner[ID:5,4]', 1443020826, 'admin', 1, '', 'banner&banner'),
	(36, '添加Banner[6]', 1443020865, 'admin', 1, '', 'banner&banner_add'),
	(37, '添加Banner[7]', 1443020876, 'admin', 1, '', 'banner&banner_add'),
	(38, '添加Banner[8]', 1443061042, 'admin', 1, '', 'banner&banner_add'),
	(39, '删除Banner[ID:]', 1443061055, 'admin', 1, '', 'banner&banner_del'),
	(40, '核销提现申请[ID:3]', 1443100107, 'admin', 1, '', 'extract_cash&cashed'),
	(41, '核销提现申请[ID:3]', 1443100216, 'admin', 1, '', 'extract_cash&cashed'),
	(42, '删除banner[ID:7]', 1443518008, 'admin', 1, '', 'banner&banner'),
	(43, '添加Banner[9]', 1443518030, 'admin', 1, '', 'banner&banner_add'),
	(44, '删除Banner[ID:2]', 1443518944, 'admin', 1, '', 'feedback&feedback_del'),
	(45, '删除feedback[ID:5,4]', 1443521508, 'admin', 1, '127.0.0.1', 'feedback&feedback'),
	(46, '添加奖项[二等奖]', 1444534271, 'admin', 1, '', 'lottery&add_awards'),
	(47, '添加奖项[三等奖]', 1444534775, 'admin', 1, '', 'lottery&add_awards'),
	(48, '编辑Banner[9]', 1444660405, 'admin', 1, '113.116.137.208', 'banner&banner_edit'),
	(49, '编辑Banner[9]', 1444660414, 'admin', 1, '113.116.137.208', 'banner&banner_edit'),
	(50, '删除Banner[ID:9]', 1444660458, 'admin', 1, '113.116.137.208', 'banner&banner_del'),
	(51, '添加会员[MOBILE:]', 1444722530, 'admin', 1, '', 'member&member_add'),
	(52, '添加会员[MOBILE:]', 1444722621, 'admin', 1, '', 'member&member_add'),
	(53, '添加Notice[1]', 1444904031, 'admin', 1, '', 'notice&notice_add'),
	(54, '添加Notice[2]', 1444919444, 'admin', 1, '', 'notice&notice_add'),
	(55, '删除Notice[ID:1]', 1444923444, 'admin', 1, '', 'notice&notice_del'),
	(56, '编辑系统公告[]', 1444962015, 'admin', 1, '', 'notice&notice_edit'),
	(57, '编辑系统公告[2]', 1444963328, 'admin', 1, '', 'notice&notice_edit'),
	(58, '编辑系统公告[2]', 1444963351, 'admin', 1, '', 'notice&notice_edit'),
	(59, '添加Notice[3]', 1444978384, 'admin', 1, '', 'notice&notice_add'),
	(60, '编辑系统公告[2]', 1444980175, 'admin', 1, '', 'notice&notice_edit'),
	(61, '添加会员[MOBILE:]', 1444987823, 'admin', 1, '', 'member&member_add'),
	(62, '编辑会员[ID:3]', 1444988106, 'admin', 1, '', 'member&member_edit'),
	(63, '添加积分商品[1]', 1445265371, 'admin', 1, '', 'points_good&points_good_add'),
	(64, '编辑积分商品[]', 1445265572, 'admin', 1, '', 'points_good&points_good_edit'),
	(65, '编辑积分商品[]', 1445265784, 'admin', 1, '', 'points_good&points_good_edit'),
	(66, '编辑积分商品[1]', 1445265845, 'admin', 1, '', 'points_good&points_good_edit'),
	(67, '编辑积分商品[1]', 1445265860, 'admin', 1, '', 'points_good&points_good_edit'),
	(68, '添加积分商品[2]', 1445269895, 'admin', 1, '', 'points_good&points_good_add'),
	(69, '添加积分商品[3]', 1445269924, 'admin', 1, '', 'points_good&points_good_add'),
	(70, '删除PointsGood[ID:3]', 1445269930, 'admin', 1, '', 'points_good&points_good_del'),
	(71, '删除points_good[ID:2]', 1445269940, 'admin', 1, '', 'points_good&points_good'),
	(72, '添加积分商品[4]', 1445269960, 'admin', 1, '', 'points_good&points_good_add'),
	(73, '审核会员通过[ID:18]', 1445318868, 'admin', 1, '60.29.154.66', 'member&pass'),
	(74, '添加会员[MOBILE:]', 1445319426, 'admin', 1, '60.29.154.66', 'member&member_add'),
	(75, '审核会员通过[ID:17]', 1445319485, 'admin', 1, '60.29.154.66', 'member&pass'),
	(76, '添加产品[SN10-404L]', 1445320309, 'admin', 1, '60.29.154.66', 'product&product_add'),
	(77, '添加管理员[1233]', 1445320400, 'admin', 1, '60.29.154.66', 'admin&admin_add'),
	(78, '添加会员[MOBILE:]', 1445320658, 'admin', 1, '60.29.154.66', 'member&member_add'),
	(79, '编辑会员[ID:23]', 1445322272, 'admin', 1, '60.29.154.66', 'member&member_edit'),
	(80, '添加Notice[4]', 1445323611, 'admin', 1, '60.29.154.66', 'notice&notice_add'),
	(81, '审核会员通过[ID:23]', 1445327481, 'admin', 1, '60.29.154.66', 'member&pass'),
	(82, '编辑积分商品[4]', 1445338761, 'admin', 1, '59.37.13.242', 'points_good&points_good_edit'),
...
-- 导出  表 bdm175223116_db.sysc_area 结构
CREATE TABLE IF NOT EXISTS `sysc_area` (
...
-- 正在导出表  bdm175223116_db.sysc_area 的数据：3,297 rows
/*!40000 ALTER TABLE `sysc_area` DISABLE KEYS */;
INSERT INTO `sysc_area` (`area_id`, `area_name`, `area_parent_id`, `area_sort`, `area_deep`, `area_region`) VALUES
	(1, '北京', 0, 0, 1, '华北'),
	(2, '天津', 0, 0, 1, '华北'),
	(3, '河北', 0, 0, 1, '华北'),
	(4, '山西', 0, 0, 1, '华北'),
...
/*!40000 ALTER TABLE `sysc_area` ENABLE KEYS */;


-- 导出  表 bdm175223116_db.sysc_banner 结构
CREATE TABLE IF NOT EXISTS `sysc_banner` (
...
CREATE TABLE IF NOT EXISTS `sysc_config` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `type` varchar(50) NOT NULL COMMENT '配置项类型',
...
-- 导出  表 bdm175223116_db.sysc_exchange_record 结构
CREATE TABLE IF NOT EXISTS `sysc_exchange_record` (
  `er_id` int(11) NOT NULL AUTO_INCREMENT,
  `member_id` int(11) NOT NULL,
  `pg_id` int(11) NOT NULL COMMENT '积分商品id',
  `pg_name` varchar(100) NOT NULL,
  `pg_number` int(5) NOT NULL COMMENT '兑换商品数量',
  `points` int(8) NOT NULL COMMENT '兑换消耗积分',
  `create_time` int(10) NOT NULL,
  PRIMARY KEY (`er_id`)
) ENGINE=MyISAM DEFAULT CHARSET=gbk;

-- 正在导出表  bdm175223116_db.sysc_exchange_record 的数据：0 rows
/*!40000 ALTER TABLE `sysc_exchange_record` DISABLE KEYS */;
/*!40000 ALTER TABLE `sysc_exchange_record` ENABLE KEYS */;


-- 导出  表 bdm175223116_db.sysc_extract_cash 结构
CREATE TABLE IF NOT EXISTS `sysc_extract_cash` (
  `cash_id` int(11) NOT NULL AUTO_INCREMENT,
  `member_id` int(11) NOT NULL,
  `member_mobile` varchar(50) NOT NULL,
  `cash_points` int(11) NOT NULL COMMENT '申请提现的积分',
  `cash_state` smallint(1) NOT NULL COMMENT '1-申请中 2-已提现',
  `create_time` int(10) NOT NULL,
...
-- 导出  表 bdm175223116_db.sysc_feedback 结构
CREATE TABLE IF NOT EXISTS `sysc_feedback` (
  `feedback_id` int(11) NOT NULL AUTO_INCREMENT,
  `feedback_content` tinytext NOT NULL,
  `feedback_img` varchar(80) DEFAULT NULL,
  `member_id` int(11) NOT NULL,
  `member_mobile` varchar(50) NOT NULL,
  `create_time` varchar(10) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `sysc_key_generator` (
  `id` int(5) NOT NULL AUTO_INCREMENT,
  `generator_type` varchar(30) NOT NULL,
  `value` int(5) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=gbk COMMENT='生成器';
...
-- 导出  表 bdm175223116_db.sysc_lock 结构
CREATE TABLE IF NOT EXISTS `sysc_lock` (
...
-- 正在导出表  bdm175223116_db.sysc_lock 的数据：0 rows
/*!40000 ALTER TABLE `sysc_lock` DISABLE KEYS */;
/*!40000 ALTER TABLE `sysc_lock` ENABLE KEYS */;


-- 导出  表 bdm175223116_db.sysc_lottery_activity 结构
CREATE TABLE IF NOT EXISTS `sysc_lottery_activity` (
  `id` smallint(5) NOT NULL AUTO_INCREMENT,
  `activity_name` varchar(45) DEFAULT NULL COMMENT '活动名称',
  `is_default` int(1) NOT NULL COMMENT '是否当前抽奖活动，1：是 0：否 当前有且只有一个活动是当前正在进行活动',
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='活动基本信息表';

-- 正在导出表  bdm175223116_db.sysc_lottery_activity 的数据：1 rows
/*!40000 ALTER TABLE `sysc_lottery_activity` DISABLE KEYS */;
INSERT INTO `sysc_lottery_activity` (`id`, `activity_name`, `is_default`, `create_time`) VALUES
	(1, '每日抽奖', 1, '2015-10-11 11:35:44');
/*!40000 ALTER TABLE `sysc_lottery_activity` ENABLE KEYS */;


-- 导出  表 bdm175223116_db.sysc_lottery_awards 结构
CREATE TABLE IF NOT EXISTS `sysc_lottery_awards` (
  `awards_id` smallint(5) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `awards_name` varchar(50) NOT NULL COMMENT '奖项名称',
  `prize_name` varchar(80) NOT NULL COMMENT '奖品名称',
  `prize_type` tinyint(1) NOT NULL COMMENT '奖品类型 1-积分 2-其它',
  `prize_points` int(8) DEFAULT NULL COMMENT '奖品类型为积分时，对应的积分值',
  `win_rate` decimal(7,6) NOT NULL COMMENT '中奖几率',
  `prize_amount` int(10) NOT NULL DEFAULT '0' COMMENT '奖品数量',
  `activity_id` smallint(5) NOT NULL COMMENT '活动id',
  `win_amount` int(10) NOT NULL DEFAULT '0' COMMENT '已中数量',
  `create_time` int(10) NOT NULL,
  PRIMARY KEY (`awards_id`)
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='奖项信息';

-- 正在导出表  bdm175223116_db.sysc_lottery_awards 的数据：3 rows
...
-- 导出  表 bdm175223116_db.sysc_lottery_participant 结构
CREATE TABLE IF NOT EXISTS `sysc_lottery_participant` (
  `id` int(9) NOT NULL AUTO_INCREMENT,
  `member_id` int(11) DEFAULT NULL COMMENT '参与会员id',
  `member_mobile` varchar(50) DEFAULT NULL COMMENT '参与会员名称',
  `is_win` int(1) DEFAULT NULL COMMENT '是否中奖 1：中奖 0：未中奖',
  `participant_time` int(10) NOT NULL COMMENT '参与时间',
  `awards_id` smallint(5) DEFAULT NULL COMMENT '奖项id',
  `awards_name` varchar(50) DEFAULT NULL COMMENT '奖项名称',
  `prize_name` varchar(80) DEFAULT NULL COMMENT '奖品名称',
  `prize_type` tinyint(1) DEFAULT NULL COMMENT '奖品类型 1-积分 2-其它',
  `prize_points` int(8) DEFAULT NULL COMMENT '奖品类型为积分时，对应的积分值',
  `activity_id` smallint(5) NOT NULL COMMENT '活动id',
  `is_get` int(1) NOT NULL DEFAULT '0' COMMENT '领奖状态 1：已领取 0：未领取',
...
-- 导出  表 bdm175223116_db.sysc_member 结构
CREATE TABLE IF NOT EXISTS `sysc_member` (
  `member_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '会员id',
  `member_name` varchar(50) DEFAULT NULL COMMENT '会员名称',
  `member_truename` varchar(50) DEFAULT NULL COMMENT '姓名',
  `member_mobile` varchar(50) NOT NULL COMMENT '用户名',
  `member_mobile_true` varchar(11) NOT NULL COMMENT '手机号',
  `member_avatar` varchar(50) DEFAULT NULL COMMENT '会员头像',
  `member_sex` tinyint(1) DEFAULT NULL COMMENT '会员性别 0-保密 1-男 2-女',
  ...
  `member_state` tinyint(1) NOT NULL COMMENT '会员的状态 0为已注册 1为待审核 2为正常（审核通过） 3为审核不通过',
  `member_type` tinyint(1) NOT NULL DEFAULT '1' COMMENT '会员类型 1为代理商 2为店面',
  `member_code` varchar(5) DEFAULT NULL COMMENT '代理商编号，会员类型为1的时候才有值',
  `parent_code` varchar(5) DEFAULT NULL COMMENT '所属代理商编号，会员类型为2时才有值',
  `create_time` varchar(10) NOT NULL COMMENT '会员注册时间',
  `shop_name` varchar(50) DEFAULT NULL COMMENT '会员类型为服务店铺时则是店铺名称，会员类型为代理商时是公司名称',
  `shop_img` varchar(100) DEFAULT NULL COMMENT '店面照片url',
  `area_name` varchar(50) DEFAULT NULL COMMENT '店铺区域名称',
  `area_id` int(11) DEFAULT NULL COMMENT '店铺区域id',
  `shop_address` varchar(200) DEFAULT NULL COMMENT '店铺地址',
  `alipay_number` varchar(50) DEFAULT NULL COMMENT '支付宝卡号',
  `bank_number` varchar(50) DEFAULT NULL COMMENT '银行卡号',
  `bank_username` varchar(50) DEFAULT NULL COMMENT '开户姓名',
  `bank_name` varchar(50) DEFAULT NULL COMMENT '银行名称',
  `bank_branch` varchar(100) DEFAULT NULL COMMENT '开户网点',
  `address_area_id` int(11) DEFAULT NULL COMMENT '用户收货地址区域id',
  `address_area_name` varchar(50) DEFAULT NULL COMMENT '用户收货地址区域名称',
  `address_detail` varchar(400) DEFAULT NULL COMMENT '用户详细地址',
...
-- 导出  表 bdm175223116_db.sysc_message 结构
CREATE TABLE IF NOT EXISTS `sysc_message` (
  `message_id` int(11) NOT NULL AUTO_INCREMENT,
  `to_member_id` int(11) NOT NULL,
  `from_member_id` int(11) NOT NULL DEFAULT '0' COMMENT '0为系统发送',
...
INSERT INTO `sysc_message` (`message_id`, `to_member_id`, `from_member_id`, `message_content`, `message_state`, `create_time`) VALUES
	...
	(4, 1, 0, '你的积分于2015-09-17 18:18:14 有变化，描述：提现，积分变化 ：-200', 1, '1442485094'),
	(5, 1, 0, '你的积分于2015-09-18 14:51:09 有变化，描述：签到，积分变化 ：2', 1, '1442559069'),
	(6, 1, 0, '你的积分于2015-09-18 16:40:43 有变化，描述：签到，积分变化 ：2', 1, '1442565643'),
	(7, 1, 0, '你的积分于2015-09-18 18:10:50 有变化，描述：签到，积分变化 ：2', 1, '1442571050'),
	(8, 2, 0, '你的积分于2015-09-22 18:27:37 有变化，描述：被推荐注册，积分变化 ：10', 1, '1442917657'),
	(9, 2, 0, '你的积分于2015-09-22 18:27:37 有变化，描述：推荐会员，积分变化 ：10', 1, '1442917657'),
	(10, 2, 0, '你的积分于2015-09-22 18:30:52 有变化，描述：被推荐注册，积分变化 ：10', 1, '1442917852'),
	(11, 1, 0, '你的积分于2015-09-22 18:30:52 有变化，描述：推荐会员，积分变化 ：10', 1, '1442917852'),
	(12, 1, 0, '你的积分于2015-10-11 17:59:53 有变化，描述：抽中三等奖，积分变化 ：100', 1, '1444557593'),
	(13, 1, 0, '你的积分于2015-10-11 18:16:34 有变化，描述：抽中三等奖，积分变化 ：100', 1, '1444558594'),
	(14, 1, 0, '你的积分于2015-10-11 18:20:48 有变化，描述：抽中三等奖，积分变化 ：100', 1, '1444558848'),
	(15, 1, 0, '你的积分于2015-10-19 02:36:50 有变化，描述：提现，积分变化 ：-201', 1, '1445193410'),
	(16, 1, 0, '你的积分于2015-10-19 16:12:23 有变化，描述：提现，积分变化 ：-300', 1, '1445242343'),
	(17, 1, 0, '你的积分于2015-10-20 10:13:53 有变化，描述：提现，积分变化 ：-200', 1, '1445307233'),
	(18, 22, 0, '你的积分于2015-10-20 22:22:44 有变化，描述：签到，积分变化 ：2', 1, '1445350964'),
...
-- 导出  表 bdm175223116_db.sysc_notice 结构
CREATE TABLE IF NOT EXISTS `sysc_notice` (
  `notice_id` int(11) NOT NULL AUTO_INCREMENT,
  `notice_title` varchar(100) NOT NULL,
  `notice_abstract` varchar(500) NOT NULL,
...
-- 导出  表 bdm175223116_db.sysc_points_good 结构
...
-- 导出  表 bdm175223116_db.sysc_points_log 结构
CREATE TABLE IF NOT EXISTS `sysc_points_log` (
  `pl_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '积分日志编号',
  `pl_memberid` int(11) NOT NULL COMMENT '会员编号',
  `pl_membermobile` varchar(50) NOT NULL COMMENT '会员用户名',
  ...
  `pl_addtime` int(10) NOT NULL COMMENT '添加时间',
...
INSERT INTO `sysc_points_log` (`pl_id`, `pl_memberid`, `pl_membermobile`, `pl_adminid`, `pl_adminname`, `pl_points`, `pl_addtime`, `pl_desc`, `pl_stage`) VALUES
	...
	(6, 1, '18682255279', NULL, NULL, 2, 1442559069, '签到', 'sign'),
	(3, 1, '18682255279', NULL, NULL, -200, 1442484723, '提现', 'extract_cash'),
	(4, 1, '18682255279', NULL, NULL, -200, 1442484968, '提现', 'extract_cash'),
	(5, 1, '18682255279', NULL, NULL, -200, 1442485094, '提现', 'extract_cash'),
	(7, 1, '18682255279', NULL, NULL, 2, 1442565643, '签到', 'sign'),
	(8, 1, '18682255279', NULL, NULL, 2, 1442571050, '签到', 'sign'),
	(11, 2, '18682255278', NULL, NULL, 10, 1442917851, '被推荐注册', 'recommed_regist'),
	(12, 1, '18682255279', NULL, NULL, 10, 1442917852, '推荐会员', 'recomm_regist'),
	(13, 1, '18682255279', NULL, NULL, 100, 1444557593, '抽中三等奖', 'win_prize'),
	(14, 1, '18682255279', NULL, NULL, 100, 1444558594, '抽中三等奖', 'win_prize'),
	(15, 1, '18682255279', NULL, NULL, 100, 1444558848, '抽中三等奖', 'win_prize'),
	(16, 1, '18682255279', NULL, NULL, -201, 1445193410, '提现', 'extract_cash'),
	(17, 1, '18682255279', NULL, NULL, -300, 1445242343, '提现', 'extract_cash'),
	(18, 1, '18682255279', NULL, NULL, -200, 1445307233, '提现', 'extract_cash'),
	(19, 22, '13642115522', NULL, NULL, 2, 1445350964, '签到', 'sign'),
...
-- 导出  表 bdm175223116_db.sysc_points_order 结构
CREATE TABLE IF NOT EXISTS `sysc_points_order` (
  ...
  `pg_number` int(6) NOT NULL COMMENT '兑换商品的数量',
...
-- 导出  表 bdm175223116_db.sysc_product 结构
CREATE TABLE IF NOT EXISTS `sysc_product` (
...
-- 导出  表 bdm175223116_db.sysc_qrcode_record 结构
CREATE TABLE IF NOT EXISTS `sysc_qrcode_record` (
...
-- 导出  表 bdm175223116_db.sysc_sign 结构
CREATE TABLE IF NOT EXISTS `sysc_sign` (
