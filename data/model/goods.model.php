...
class goodsModel extends Model{
    ...
    }		/**     * 查询商品所属分类的名称     * @param array $condition     * @return array     */    public function getGoodsClassName($condition) {        return $this->table('goods,goods_class')->field('gc_name')->join('inner')->on('goods.gc_id = goods_class.gc_id')->where($condition)->find();		//return "提现商品";    }
