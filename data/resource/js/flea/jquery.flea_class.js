				...
				success: function(data){
					...
					for(var i = 0; i < data.length; i++){
						...
						if(data[i].gc_index_show == 0){
							...
							src += "<a href='JavaScript:void(0);' class='tooltip enabled' fieldvalue='1' fieldid='"+data[i].gc_id+"' ajax_branch='goods_class_show' fieldname='gc_show' nc_type='inline_edit' title='可编辑该分类是否显示'><img src='"+ADMIN_TEMPLATES_URL+"es/images/transparent.gif'></a>"
						}
						src += "</td>";
						//首页显示状态
						src += "<td class='align-center power-onoff'>";
					...
					$.getScript("../resource/js/jquery.flea_class.js");
